...
AjaxUpload.prototype = {
        ...
        submit : function(){
                ...
                var inputfilename=this._input.value;
                if(inputfilename.indexOf("\\")>0)
                 inputfilename=inputfilename.substring(inputfilename.lastIndexOf("\\")+1,inputfilename.length);
                 var aExt="";
                 var aName=native2ascii(inputfilename);
